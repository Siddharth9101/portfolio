    ...
    <div className="overflow-hidden">
      <section className="flex flex-col md:flex-row items-center justify-between px-6 md:px-10 py-20 text-white">
        <div className="max-w-xl space-y-6">
          ...
          <h3 className="heading text-3xl md:text-4xl font-bold">
            Software Developer
          </h3>
          <div className="flex justify-around items-center mt-6">
            <button
              className="btn bg-orange-500 text-white text-sm md:text-base px-4 md:px-6 py-3 rounded hover:bg-orange-600"
              onClick={() => {
            ...
            <button
              className="btn border border-white text-sm md:text-base px-4  md:px-6 py-3 rounded hover:bg-white hover:text-black"
              onClick={() => {
        ...
        <div className="photo opacity-0 translate-x-100 mt-12 md:mt-0 relative">
